...
public class ControllerAdviceClass extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ExceptionResponse> handleAnyNullPointerException(Exception ex, WebRequest request)
			throws Exception {
	...
	public final ResponseEntity<ExceptionResponse> handleUnAuthReqException(Exception ex, WebRequest request)
			throws Exception {
		log.error("handleUserNotFoundException()");
